...
class TestSync(unittest.TestCase):
    ...
    @patch("tap_segment.streams.abstracts.ParentBaseStream.is_selected", return_value=True)
    @patch("tap_segment.streams.abstracts.ParentBaseStream.get_bookmark", return_value=100)
    ...
    @patch("tap_segment.streams.abstracts.IncrementalStream.get_bookmark", return_value = 100)
    ...
    @patch("tap_segment.streams.abstracts.BaseStream.is_selected", return_value=True)
    @patch("tap_segment.streams.abstracts.IncrementalStream.get_bookmark", side_effect = [100, 50, 75])
