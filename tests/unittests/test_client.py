...
class TestClient(unittest.TestCase):
    ...
    @patch("tap_segment.client.session")
    ...
    @parameterized.expand([
        ["400 error", 400, MockResponse(400), SegmentBadRequestError, "A validation exception has occurred."],
        ["401 error", 401, MockResponse(401), SegmentUnauthorizedError, "The access token provided is expired, revoked, malformed or invalid for other reasons."],
        ["403 error", 403, MockResponse(403), SegmentForbiddenError, "You are missing the following required scopes: read"],
        ["404 error", 404, MockResponse(404), SegmentNotFoundError, "The resource you have specified cannot be found."],
